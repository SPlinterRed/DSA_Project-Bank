...
void Bank::regacc(){ 
    details x;
    string newname;int newbalance;int newpin;long newcontact;int newaccountnum;int depo;
    cout<<"INPUT YOUR NAME: "<<endl;
    cin>>newname;
    cout<<"Deposit Initial Balance(Min 5000): ";
    cin>>depo;
    newbalance = inidepo(depo);
